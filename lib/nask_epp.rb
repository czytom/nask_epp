...
module NaskEpp
  ...
  when "8.0"
    EPP_SCHEMA = "http://www.dns.pl/nask-epp-schema/epp-2.1"
    EPP_SCHEMA_LOCATION = EPP_SCHEMA + " epp-2.1.xsd"
    CONTACT_SCHEMA = "http://www.dns.pl/nask-epp-schema/contact-2.1"
    CONTACT_SCHEMA_LOCATION = CONTACT_SCHEMA + " contact-2.1.xsd"
    HOST_SCHEMA = "http://www.dns.pl/nask-epp-schema/host-2.1"
    HOST_SCHEMA_LOCATION = HOST_SCHEMA + " host-2.1.xsd"
    DOMAIN_SCHEMA = "http://www.dns.pl/nask-epp-schema/domain-2.1"
    DOMAIN_SCHEMA_LOCATION = DOMAIN_SCHEMA + " domain-2.1.xsd"
    EXTCON_SCHEMA = "http://www.dns.pl/nask-epp-schema/extcon-2.1"
    EXTCON_SCHEMA_LOCATION = EXTCON_SCHEMA + " extcon-2.1.xsd"
    EXTDOM_SCHEMA = "http://www.dns.pl/nask-epp-schema/extdom-2.1"
    EXTDOM_SCHEMA_LOCATION = EXTDOM_SCHEMA + " extdom-2.1.xsd"
    EXTREPORT_SCHEMA = "http://www.dns.pl/nask-epp-schema/extreport-2.1"
    EXTREPORT_SCHEMA_LOCATION = EXTREPORT_SCHEMA + " extreport-2.1.xsd"
    FUTURE_SCHEMA = "http://www.dns.pl/nask-epp-schema/future-2.1"
    FUTURE_SCHEMA_LOCATION = FUTURE_SCHEMA + " future-2.1.xsd"
    SECDNS_SCHEMA = "http://www.dns.pl/nask-epp-schema/secDNS-2.1"
    SECDNS_SCHEMA_LOCATION = SECDNS_SCHEMA + " secDNS-2.1.xsd"
  end
end
